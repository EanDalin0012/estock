...
@Component({
  selector: 'app-sale-product-type',
  templateUrl: './sale-product-type.component.html',
  styleUrls: ['./sale-product-type.component.css']
})
export class SaleProductTypeComponent implements OnInit {
