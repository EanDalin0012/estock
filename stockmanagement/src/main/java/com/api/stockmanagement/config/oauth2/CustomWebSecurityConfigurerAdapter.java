...
import com.api.stockmanagement.common.encryption.Encoders;
...
public class CustomWebSecurityConfigurerAdapter extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private UserDetailService appUserRepository;
...
//
//        auth.authenticationProvider(new CustomAuthenticationProvider(appUserRepository));
//    }
