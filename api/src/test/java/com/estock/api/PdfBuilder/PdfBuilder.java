package com.estock.api.PdfBuilder;
...
public class PdfBuilder {
    ...
    public static void main(String[] args) {
        ...
        PdfBuilder generateInvoice = new PdfBuilder();
        if (args.length < 1)
        {
    ...
    private void generateLayout(Document doc, PdfContentByte cb)  {
        ...
        try {
            ...
            //add the images
            Image companyLogo = Image.getInstance("C:\\Users\\Eanda\\OneDrive\\Pictures\\Saved Pictures\\sales-Excel-Invoice2-1.png");
